...
<body>
	...
	<section>
		...
		<article>
			<form method="POST" action="myController.php">
				<input type="hidden" name="action" value="transfert"> <input
					type="hidden" name="mytoken" value="<?php echo $mytoken; ?>">
				<div class="fieldset">
					<div class="fieldset_label">
						<span>Transferer de l'argent</span>
					</div>
					<div class="field">
						<label>No compte destinataire : </label><input type="text"
							size="20" name="destination">
					</div>
					<div class="field">
						<label>Montant a transferer : </label><input type="text" size="10"
							name="montant">
					</div>
		...
		<article>
            ...
            ?>
              <p>
						<a href="myController.php?action=msglist">Mes messages recus</a>
					</p>
				</div>
			</form>
		</article>
		...
		<article>
			<form method="POST" action="myController.php">
			<div class="fieldset">
				<input type="hidden" name="action" value="fichlist">
				<button class="form-btn">Consulter la liste des fichiers clients.</button>
				</div>
			</form>
		</article>
	</section>
